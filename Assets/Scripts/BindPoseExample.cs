...
public class BindPoseExample : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        NodeA.transform.parent = bones[0].transform;
        ...
        NodeB.transform.parent = bones[1].transform;
        // Set the position relative to the parent
        ...
        curve.keys = new Keyframe[] { new Keyframe(0, 0, 0, 0), new Keyframe(1, 1, 0, 0), new Keyframe(2, 0.0F, 0, 0) };
